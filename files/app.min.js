...
$(window).scroll(function () {
    var icons = $('.js-social-link .fab'),
        light_pos = $('#contact').offset().top
        icons_pos = icons.offset().top,
        change_colour = (icons_pos > light_pos)
    if (change_colour) { icons.addClass('light'); } else { icons.removeClass('light'); }
})
